...
const orders = [
    { orderId : "orderId1",orderCode: "orderCode1", customerId : "customerId1", items : [ { itemId : 3, apolloCount: 5, product: { productId : "productId1", apolloBrand : "brand1", apolloDecription : "description1"}}, { itemId : 4, apolloCount: 5, product: { productId : "productId3", apolloBrand : "brand3", apolloDecription : "description3"}},]},
    { orderId : "orderId2",orderCode: "orderCode2", customerId : "customerId2", items : [ { itemId : 1, apolloCount: 5, product: { productId : "productId1", apolloBrand : "brand1", apolloDecription : "description1"}}, { itemId : 2, apolloCount: 5, product: { productId : "productId3", apolloBrand : "brand3", apolloDecription : "description3"}},]},
